...
void Menu::render()
{
    ...
    TextureManager::getInstance()->drawText("MenuStartGame", "Start Game", 600, 350, colorMenuStart, Engine::GetInstance()->m_MenuStartGameFont);
    int w, h;
    ...
    StartGame = {600, 350, w, h};

    TextureManager::getInstance()->drawText("MenuQuitGame", "Quit Game", 600, 450, colorMenuQuit, Engine::GetInstance()->m_MenuStartGameFont);
    w = TextureManager::getInstance()->m_getTextureWidth["MenuQuitGame"];
    h = TextureManager::getInstance()->m_getTextureHeight["MenuQuitGame"];
    QuitGame = {600, 450, w, h};
    return;
}
